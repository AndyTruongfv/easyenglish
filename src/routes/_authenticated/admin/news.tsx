...
function AdminPage() {
  ...
  const isVIP = dashData?.profile?.is_vip === true || (dashData?.profile as any)?.role === 'admin';
...
<div style="background:rgba(99,102,241,0.06);border:2px solid #6366f1;border-radius:16px;padding:16px;margin-bottom:16px;line-height:1.9;font-size:14px;">
            ...
            <div className="overflow-x-auto rounded-3xl border border-border bg-card shadow-sm">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {usersProgress?.profiles.map((profile: any) => {
